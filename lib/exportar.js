...
function montarAba(pasta, dia, data, militares, marcacoes) {
  ...
  // Alturas: a linha 6 precisa ser alta porque os titulos dela sao verticais;
  // as linhas da relacao ficam compactas, como no formulario impresso.
  const alturas = {
    1: 12, 2: 15, 3: 15, 4: 18, 5: 16, 6: 58,
    7: 14, 8: 14, 9: 14, 10: 14, 11: 14,
    12: 12, 13: 15, 14: 12, 15: 12,
    16: 16, 17: 13,
  };
  Object.entries(alturas).forEach(([linha, altura]) => {
