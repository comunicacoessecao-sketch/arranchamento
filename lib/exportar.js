...
export function montarPasta(ExcelJS, militares, marcacoes, segunda) {
...
export async function baixarExcel(militares, marcacoes, segunda) {
  ...
  const { pasta, datas } = montarPasta(ExcelJS, militares, marcacoes, segunda);
  ...
  link.href = url;
  link.download = `arranchamento_${datas[PRIMEIRO_DIA].curta.replace("/", "-")}.xlsx`;
